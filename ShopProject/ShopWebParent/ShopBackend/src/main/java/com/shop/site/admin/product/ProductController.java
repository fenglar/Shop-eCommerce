...
import com.shop.site.admin.brand.BrandService;
...
public class ProductController {
    ...
    public String deleteCategory(@PathVariable(name = "id") Integer id, Model model,
        ...
        try {
            ...
            String productExtraImagesDir = "../product_images/" + id + "/extras";
            String productImagesDir = "../product_images/" + id;
    ...
    public String editProduct(@PathVariable("id") Integer id, Model model,
                              RedirectAttributes ra, @AuthenticationPrincipal ShopUserDetails loggedUser) throws ProductNotFoundException {
        try {
